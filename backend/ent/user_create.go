...
func (uc *UserCreate) AddCAREIDs(ids ...int) *UserCreate {
	uc.mutation.AddCAREIDs(ids...)
	return uc
}

// AddCARE adds the CARE edges to Antenatal.
func (uc *UserCreate) AddCARE(a ...*Antenatal) *UserCreate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uc.AddCAREIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.CAREIDs(); len(nodes) > 0 {
