...
func (e PatientEdges) SETMOMOrErr() ([]*Antenatal, error) {
	if e.loadedTypes[0] {
		return e.SETMOM, nil
	}
...
// QuerySETMOM queries the SETMOM edge of the Patient.
func (pa *Patient) QuerySETMOM() *AntenatalQuery {
	return (&PatientClient{config: pa.config}).QuerySETMOM(pa)
}
