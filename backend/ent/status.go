...
import (
	...
	"github.com/F12aPPy/app/ent/status"
...
func (e StatusEdges) SETSTATUSOrErr() ([]*Antenatal, error) {
	if e.loadedTypes[0] {
...
func (s *Status) assignValues(values ...interface{}) error {
	...
	if value, ok := values[0].(*sql.NullString); !ok {
		...
		s.STATUSBABYNAME = value.String
	}
	return nil
}

// QuerySETSTATUS queries the SETSTATUS edge of the Status.
func (s *Status) QuerySETSTATUS() *AntenatalQuery {
	return (&StatusClient{config: s.config}).QuerySETSTATUS(s)
}
...
func (s *Status) String() string {
	...
	builder.WriteString(s.STATUSBABYNAME)
	builder.WriteByte(')')
