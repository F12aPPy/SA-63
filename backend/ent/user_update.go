...
func (uu *UserUpdate) AddCAREIDs(ids ...int) *UserUpdate {
	uu.mutation.AddCAREIDs(ids...)
	return uu
}

// AddCARE adds the CARE edges to Antenatal.
func (uu *UserUpdate) AddCARE(a ...*Antenatal) *UserUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uu.AddCAREIDs(ids...)
}
...
func (uu *UserUpdate) RemoveCAREIDs(ids ...int) *UserUpdate {
	uu.mutation.RemoveCAREIDs(ids...)
	return uu
}

// RemoveCARE removes CARE edges to Antenatal.
func (uu *UserUpdate) RemoveCARE(a ...*Antenatal) *UserUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uu.RemoveCAREIDs(ids...)
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := uu.mutation.RemovedCAREIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.CARETable,
			Columns: []string{user.CAREColumn},
			Bidi:    false,
	...
	if nodes := uu.mutation.CAREIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.CARETable,
...
// AddCAREIDs adds the CARE edge to Antenatal by ids.
func (uuo *UserUpdateOne) AddCAREIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.AddCAREIDs(ids...)
	return uuo
}

// AddCARE adds the CARE edges to Antenatal.
func (uuo *UserUpdateOne) AddCARE(a ...*Antenatal) *UserUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uuo.AddCAREIDs(ids...)
}
...
// RemoveCAREIDs removes the CARE edge to Antenatal by ids.
func (uuo *UserUpdateOne) RemoveCAREIDs(ids ...int) *UserUpdateOne {
	uuo.mutation.RemoveCAREIDs(ids...)
	return uuo
}

// RemoveCARE removes CARE edges to Antenatal.
func (uuo *UserUpdateOne) RemoveCARE(a ...*Antenatal) *UserUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return uuo.RemoveCAREIDs(ids...)
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (u *User, err error) {
	...
	if nodes := uuo.mutation.RemovedCAREIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.CARETable,
	...
	if nodes := uuo.mutation.CAREIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.CARETable,
